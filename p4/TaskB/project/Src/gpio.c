...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_14|BTN1_Pin|SEGA_Pin|SEGDP_Pin
                          |SEGG_Pin|SEGB_Pin|SEGF_Pin|SEGC_Pin
  ...
  /*Configure GPIO pins : PJ15 PJPin */
  GPIO_InitStruct.Pin = GPIO_PIN_15|BTN2_Pin;
  ...
  /*Configure GPIO pins : PJ14 PJPin PJPin PJPin
                           ...
                           PJPin PJPin */
  GPIO_InitStruct.Pin = GPIO_PIN_14|BTN1_Pin|SEGA_Pin|SEGDP_Pin
                          |SEGG_Pin|SEGB_Pin|SEGF_Pin|SEGC_Pin
                          |SEGD_Pin|SEGE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
